...
<head>
    ...
    <title>WIRAS - Wadihuda Institute of Research and Advanced Studies</title>
...
<body>
    ...
    <main>
        <!-- hero-area-start -->
        <div class="hero-area-3 hero-height-3" data-background="assets/img/slider/hero-3.jpg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-9 text-center">
                        <div class="hero-university-text">
                            <h2>Education Is The Power Of Humanity</h2>
                        </div>
                        <div class="university-btn">
                            <a class="edu-five-btn" href="#">Apply Online</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="university-main-wraper d-flex align-items-center">
                            <div class="university-course-box">
                                <div class="university-card-text">
                                    ...
                                    <h3>Earn Your Degree
                                        from <span>WIRAS</span></h3>
                                    <a class="edu-six-btn" href="courses.php">View courses</a>
                                </div>
                            </div>
                            <div class="university-card-wrapper">
                                ...
                                <div class="university-card-content">
                                    <h3>About</h3>
                                    <p>The 11 acre campus provides a serene atmosphere conducive to academic, intellectual.</p>
                                </div>
                            </div>
                            <div class="university-card-wrapper">
                                <div class="university-card-icon">
                                ...
                                <div class="university-card-content">
                                    <h3>Mission</h3>
                                    <p>To focus on building a caring and inclusive culture through sensitizing the student populace.</p>
                                </div>
                            </div>
                            <div class="university-card-wrapper">
                                <div class="university-card-icon">
                                ...
                                <div class="university-card-content">
                                    <h3>Vision</h3>
                                    <p>To be a centre of excellence nurturing leaders to develop an ideal society.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3">
                        <div class="section-title mb-30">
                            <h2>Wadihuda Institute of Research and Advanced Studies</h2>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4">
                        <div class="message-profile-text">
                            <span>To be a centre of excellence nurturing leaders to develop an ideal society.
                            </span>
                            <p>Founded in 2010, the Wadihuda Institute of Research and Advanced Studies (WIRAS) is affiliated to Kannur University and recognised by the Govt. of Kerala. It is a premier institute of the Ta'aleemul Islam Trust. The 11 acre campus provides a serene atmosphere conducive to academic, intellectual and physical pursuits.</p>
                        </div>
                        <div class="university-btn">
                            <a class="edu-five-btn" href="about.php">Read More</a>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        <div class="message-sticker position-relative">
                            <img src="assets/img/message-sticke1r.png" alt="img">
                            <div class="etablist-price">
                                <p> Etablished <span>1990</span> KERALA</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="academic-courses-area p-relative pt-100 pb-100">
            <img class="academic-shape-2" src="assets/img/acadenic-shape-2.png" alt="shape">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-4">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="academic-box position-relative mb-30">
                            <img class="academic-shape" src="assets/img/acadenic-shape-1.png"
                                alt="image not found">
                            <div class="academic-thumb">
                                <img src="assets/img/study-1.jpg" alt="image not found">
                            </div>
                            <div class="academic-content">
                                <div class="academic-content-header">
                                    <a href="#">
                                        <h3>B.Sc Physics & Mathematics </h3>
                                    </a>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="academic-box mb-30">
                            <div class="academic-thumb">
                                <img src="assets/img/study-2.jpg" alt="image not found">
                            </div>
                            <div class="academic-content">
                                <div class="academic-content-header">
                                    <a href="#">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="academic-box mb-30">
                            <div class="academic-thumb">
                                <img src="assets/img/study-3.jpg" alt="image not found">
                            </div>
                            <div class="academic-content">
                                <div class="academic-content-header">
                                    <a href="#">
                                        <h3>B.Sc Psychology & Physiology.</h3>
                                    </a>
                                </div>
                                <div class="academic-body">
                                    <p>Helping employees gain skills and development often take a back seat to business
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="academic-box mb-30">
                            <div class="academic-thumb">
                                <img src="assets/img/study-4.jpg" alt="image not found">
                            </div>
                            <div class="academic-content">
                                <div class="academic-content-header">
                                    <a href="#">
                                        <h3>B.Com-Computer Applicatio</h3>
                                    </a>
                                </div>
                                <div class="academic-body">
                                    <p>Helping employees gain skills and development often take a back seat to business
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-3 text-center">
                        <div class="academic-bottom-btn ">
                            <a class="edo-theme-btn mt-30" href="courses.php">View all course</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--counter-area-start -->
        <div class="counter-area pt-75 pb-30" data-background="assets/img/university-counter.png">
            <div class="container">
                <div class="row">
                ...
                <div class="campus-wrapper position-relative">
                    <div class="campus-shape-sticker">
                        <div class="shape-light">
                            <img src="assets/img/shape-light.png" alt="image not found">
                        </div>
                        <div class="campus-shape-content">
                            <h5>Students Enjoy Their
                                        Lives at WIRAS Campus</h5>
                        </div>
                    </div>
                    <div class="campus-shape-1">
                        <img src="assets/img/campus-shape-2.png" alt="shape">
                    </div>
                    <div class="campus-shape-2">
                        <img src="assets/img/student-shape-05.png" alt="shape">
                    </div>
                    <div class="row align-items-center">
                        <div class="col-xl-5 col-lg-6">
                            <div class="compus-content mb-30">
                                ...
                                <ul>
                                    <li><i class="far fa-check">To focus on building a caring and inclusive culture through sensitizing the student populace.</i></li>
                                    <li><i class="far fa-check">To invest in inculcating human, social and ethical values by promoting reflective practices</i></li>
                                    <li><i class="far fa-check">To strive for a progressive, just and egalitarian social order by ensuring equal opportunity to all.</i></li>
                                    <li><i class="far fa-check">To encourage global perspectives on tolerance and understanding for the prevalence of universal brotherhood.</i></li>
                                    <li>To manifest as a learning organization through continuous research and adoption of best practices.</i></li>
                        ...
                        <div class="col-xl-6 offset-xl-1 col-lg-6">
                            <div class="campus-img-wrapper position-relative">
                                <div class="campus-shape-3">
                                    <img src="assets/img/campus-shape-1.png" alt="image not found">
                                </div>
                                <div class="campus-img-1">
                                    <img src="assets/img/campus-img-1.png" alt="image not found">
                                </div>
                                <div class="campus-img-2">
                                    <img src="assets/img/campus-img-2.png" alt="image not found">
                                </div>
                                <div class="campus-img-3">
                                    <img src="assets/img/campus-img-3.png" alt="image not found">
                                </div>
                                <div class="campus-img-4">
                                    <img src="assets/img/campus-img-4.png" alt="image not found">
                                </div>
                                <div class="campus-img-5">
                                    <img src="assets/img/campus-img-5.png" alt="image not found">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- events-area-start -->
        <div class="event-area pt-100 pb-90">
            <div class="event-shape-wrapper position-relative">
                <div class="event-shape">
                    <img src="assets/img/testimonial/feedback-img.png" alt="image not found">
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-12">
                        ...
                        <div class="current-event-box mb-15">
                            <div class="current-event-date d-flex position-relative">
                                <div class="event-date-wrapper">
                                    ...
                                    <span class="event-month">Jan 21</span>
                                </div>
                                <div class="event-tour">
                                    <div class="event-box-text">
                                        <h3><a href="#">Education Autumn Tour</a></h3>
                                        <span><i class="fal fa-clock"></i>12:30 AM</span>
                                        <span><i class="flaticon-place"></i>Zeoyan Stadium, London</span>
                                    </div>
                        ...
                        <div class="current-event-box mb-15">
                            <div class="current-event-date d-flex position-relative">
                                <div class="event-date-wrapper">
                                    ...
                                    <span class="event-month">Mar 21</span>
                                </div>
                                <div class="event-tour">
                                    <div class="event-box-text">
                                        <h3><a href="#">Education Summer Tour</a></h3>
                                        <span><i class="fal fa-clock"></i>10:30 AM</span>
                                        <span><i class="flaticon-place"></i>Zeoyan Stadium, London</span>
                                    </div>
                                    <a href="#" class="event-arrow">
                                        <i class="fal fa-arrow-right"></i>
                        ...
                        <div class="current-event-box mb-30">
                            <div class="current-event-date d-flex position-relative">
                                <div class="event-date-wrapper">
                                    <span class="event-date">25</span>
                                    <span class="event-month">April 21</span>
                                </div>
                                <div class="event-tour">
                                    <div class="event-box-text">
                                        <h3><a href="#">Education Spring Tour</a></h3>
                                        <span><i class="fal fa-clock"></i>09:30 AM</span>
                                        <span><i class="flaticon-place"></i>Zeoyan Stadium, London</span>
                                    </div>
                                    <a href="#" class="event-arrow">
                                        <i class="fal fa-arrow-right"></i>
                                            ...
                                            <div class="feedback-items position-relative">
                                                <div class="feedback-header">
                                                    <div class="feedback-img">
                                                        <img src="assets/img/testimonial/Image.png"
                                                            alt="image not found">
                                                    </div>
                                                ...
                                                <div class="feedback-body">
                                                    <h3>Great Institution !</h3>
                                                    <p>Choosing Wadihuda College was the best decision of my life. The comprehensive curriculum and nurturing environment have prepared me for a successful future.</p>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="feedback-content mb-30">
                                            <div class="feedback-items position-relative">
                                                <div class="feedback-header">
                                                    <div class="feedback-img">
                                                        <img src="assets/img/testimonial/testimonial-02.png"
                                                            alt="image not found">
                                                    </div>
                                                    <div class="feedback-title">
                                                ...
                                                <div class="feedback-body">
                                                    ...
                                                    <p>Wadihuda College's inclusive environment, dedicated faculty, and engaging extracurricular activities enhanced my personal and academic growth</p>
                                                </div>
                                                <div class="testimonial-icon">
                                                    <i class="fas fa-star"></i>
                                                    <i class="fas fa-star"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="feedback-content mb-30">
                                            <div class="feedback-items position-relative">
                                                <div class="feedback-header">
                                                    <div class="feedback-img">
                                                        <img src="assets/img/testimonial/testimonial.png"
                                                            alt="image not found">
                                                    </div>
                                                    <div class="feedback-title">
                                                        <h4>Riya Ashraf</h4>
                                                ...
                                                <div class="feedback-body">
                                                    ...
                                                    <p>Wadihuda College's emphasis on practical learning, research opportunities, and holistic development has equipped me with the skills necessary to thrive in the competitive job market.</p>
                                                </div>
                                                <div class="testimonial-icon">
                                                    <i class="fas fa-star"></i>
                                                    <i class="fas fa-star"></i>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12 text-center">
                        <div class="section-title mb-55">
                            <h2>Read Our <span class="down-mark-line-2">Latest</span> News</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="blog-wrapper position-relative mb-30">
                            <div class="blog-thumb ">
                                <a href="#"><img src="assets/img/blog-01.jpg" alt="blog-img"></a>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="blog-wrapper position-relative mb-30">
                            <div class="blog-thumb ">
                                <a href="#"><img src="assets/img/blog-02.jpg" alt="blog-img"></a>
                            </div>
                            <a href="#" class="blog-tag">
                                <i class="fal fa-folder-open"></i>
                                Business
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="blog-wrapper position-relative mb-30">
                            <div class="blog-thumb ">
                                <a href="#"><img src="assets/img/blog-03.jpg" alt="blog-img"></a>
                            </div>
                            <a href="#" class="blog-tag">
                                <i class="fal fa-folder-open"></i>
                                Web Design
